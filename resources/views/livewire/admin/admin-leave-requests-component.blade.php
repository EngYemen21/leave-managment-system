...
<div class="">
 ...
 {{--  ................ --}}
                  ...
                  <tr class="text-gray-700 dark:text-gray-400">
                    <td class="px-4 py-3">
                      <div class="flex items-center text-sm">
                        ...
                        <div><p class="font-semibold">{{ $request->employee->employee_name }}</p>
                          {{--
                    ...
                    <td class="py-3 text-sm px-">
                      {{ $request->employee->employee_number }}
                    </td>
                    <td class="py-3 text-xs px-">

                      {{ $request->employee->mobile_number }}
                    </td>
                    <td class="py-3 text-sm px-">
                      {{-- 6/10/2020 --}}
                    ...
                    <td class="px-2 py-2">
                        <button wire:click="approve({{ $request->id }})" class="px-2 py-1 text-white bg-green-500 rounded">
                            approve
                        </button>
                        <button wire:click="reject({{ $request->id }})" class="px-2 py-1 text-white bg-red-500 rounded">
                            reject
                        </button>
                    </td>
                  </tr>
              ...
              @empty
                  <tr>
                      <td colspan="9" class="p-4 text-center text-white">لا توجد طلبات إجازة حالياً.</td>
                  </tr>
              @endforelse
